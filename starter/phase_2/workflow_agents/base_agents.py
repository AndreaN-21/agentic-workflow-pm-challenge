...
class DirectPromptAgent:
    ...
    def __init__(self, openai_api_key, openai_base_url="https://openai.vocareum.com/v1"):
...
class AugmentedPromptAgent:
    def __init__(self, openai_api_key, persona, openai_base_url="https://openai.vocareum.com/v1"):
...
class KnowledgeAugmentedPromptAgent:
    def __init__(self, openai_api_key, persona, knowledge, openai_base_url="https://openai.vocareum.com/v1"):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": f"""You are {self.persona} knowledge-based assistant. Forget all previous context. 
                 Use only the following knowledge to answer, do not use your own knowledge: {self.knowledge}. Answer the prompt based on this knowledge, not your own."""},
                {"role": "user", "content": input_text}
            ],
            temperature=0
        )
...
class RAGKnowledgePromptAgent:
    ...
    def __init__(self, openai_api_key, persona, chunk_size=2000, chunk_overlap=100, openai_base_url="https://openai.vocareum.com/v1"):
        """
...
class RoutingAgent():
    ...
    def __init__(self, openai_api_key, agents, openai_base_url="https://openai.vocareum.com/v1"):
        # Initialize the agent with given attributes
        self.openai_api_key = openai_api_key
        self.agents = agents
        self.openai_base_url = openai_base_url
...
class ActionPlanningAgent:
    ...
    def __init__(self, openai_api_key, knowledge, openai_base_url="https://openai.vocareum.com/v1"): 
        self.openai_api_key = openai_api_key
        self.openai_base_url = openai_base_url
        self.knowledge = knowledge
    ...
    def extract_steps_from_prompt(self, prompt): 
        ...
        if response_text.startswith("Steps:"):
